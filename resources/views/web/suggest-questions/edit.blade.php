        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(['action' => ['Web\SuggestQuestionsController@update', $sgQuestions->id], 
                        'method' => 'PUT', 'class' => 'form-horizontal']) !!}
                        <div class="form-group">
                            {!! Form::label('name', trans('front-end/users.suggest-question.subject'), ['class' => 'col-sm-1 control-label']) !!}
                            <div class="col-sm-12">
                                {!! Form::select('subject', $subject, $sgQuestions->subject->id, [
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                {!! Form::textarea('content', $sgQuestions->content, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!! Form::label('type', trans('front-end/users.suggest-question.type'), ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-10">
                                {!! Form::select('type', getOptions('options.question-type'), $sgQuestions->type, [
                                    'placeholder' => trans('common/placeholders.options'),
                                    'class' => 'form-control',
                                    'id' =>  'question-type'
                                ]) !!}
            ...
            <div id="answer-section">
                ...
                @if (old('answer'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox-remove">
                                <div class="col-sm-2">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::hidden('answer[' . $key . '][is_correct]', config('answer.correct.false')) !!}
                                            {!! Form::checkbox('answer[' . $key . '][is_correct]', config('answer.correct.true'), 
                                                old('answer[' . $key . '][is_correct]'), ['class' => 'is_correct']) 
                                            !!}
                                ...
                                <div class="col-sm-2">
                                    <button class="remove-answer btn btn-default" onclick="">
                    ...
                    @endforeach
                @else
                    @foreach ($sgQuestions->systemAnswers as $key => $answer)
                    <div class="form-group">
                        {!! Form::label('answer', trans('common/labels.answer'), ['class' => 'col-sm-2 control-label']) !!}
                        <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <hr>
                    <div class="col-sm-10">
                        {!! Form::submit(trans('common/buttons.update'), ['class' => 'btn btn-primary']) !!}
